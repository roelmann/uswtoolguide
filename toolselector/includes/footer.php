<div class="footer">
	...
	<div class="row flex-container">
		...
		<div class="more flex-item panel panel-default">
			<div class="panel-body">
				<h3>USW Support Pages</h3>
				<ul>
					<li>http://teach.southwales.ac.uk</li>
					<li>http://studentit.southwales.ac.uk</li>
					<li>Blackboard Organisation - Enhancing Learning Through Technology</li>
				</ul>
