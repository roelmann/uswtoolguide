<div class="footer">
	<div class="row flex-container">
		<div class="key flex-container flex-item">
			...
			<div class="flex-item flex-container panel panel-warning">
				<div class="panel-heading">
					<i class="fa fa-2x fa-exclamation-triangle"></i>
					<p>Can work with some learning design</p>
				</div>
			</div>
			<div class="flex-item flex-container panel panel-danger">
				<div class="panel-heading">
		...
		<div class="more flex-item panel panel-default">
			<div class="panel-body">
				<h3>Need more help with UniLearn</h3>
				<p>Find it with these links...</p>
				<ul>
					<li><a href="http://teach.southwales.ac.uk">The TEACH channel - teach.southwales.ac.uk</a></li>
					<li><a href="http://teach.southwales.ac.uk/about">Your support teams - http://teach.southwales.ac.uk/about/</a></li>
					<li><a href="http://its.southwales.ac.uk">IT Services - http://its.southwales.ac.uk/</a></li>
				</ul>
			</div>
		</div><!-- more info -->
	</div><!-- row -->
		<div class="well credits">
		    ...
		    <p>The Tool Selector is based on the concepts and the overview of the <a href="https://dl.dropboxusercontent.com/u/423876/Moodle/Index.html" alt="Tool selector link">Tool Selection Decision Tree</a> by Alison Ruth</p>			<p><img src="images/by-nc-sa.png" alt="Creative Commons licence - by, nc, sa"> As defined in the original, this work is released under a <a href="https://creativecommons.org/licenses/">Creative Commons, with attribution, non-commercial, share-alike licence.</a></p>
		</div>
</div><!-- footer -->
